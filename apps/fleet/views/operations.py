...
from apps.fleet.models import Maintenance,Downtime,ReturnToService
from apps.fleet.serializers import DowntimeSerializer,MaintenanceSerializer, ReturnToServiceSerializer
